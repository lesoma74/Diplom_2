...
class TestOrderCreation:
    ...
    def create_order_without_ingredients(self, headers):
        ...
        assert order_response_no_ingredients.json() == {"success": False, "message": "Ingredient ids must be provided"}
...
class TestOrderCreationWithoutAuthorization:
    ...
    def test_order_creation_without_authorization(self):
        ...
        assert empty_data["message"] == "Ingredient ids must be provided", f"Unexpected message: {empty_data['message']}"